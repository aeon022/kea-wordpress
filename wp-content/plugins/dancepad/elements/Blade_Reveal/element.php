...
if(get_option('dan_blade_reveal_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\BladeReveal",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class BladeReveal extends \Breakdance\Elements\Element
{
    ...
    {
        return [
          '0' =>  ['title' => 'Dancepad - Blade Reveal','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Blade_Reveal/dancepad_blade_reveal.min.js?ver=' . DANCEPAD_VERSION],],
          '1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_blade_reveal();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],
          '2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_blade_reveal();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],
...
'onPropertyChange' => [['script' => 'dancepad_blade_reveal();',
],],

'onCreatedElement' => [['script' => 'dancepad_blade_reveal();',
],],

'onMountedElement' => [['script' => 'dancepad_blade_reveal();',
],],

'onMovedElement' => [['script' => 'dancepad_blade_reveal();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_blade_reveal();',
],],];
    }
    ...
    static function attributes()
    {
        return [
            ...
            ['name' => 'data-from', 'template' => '{{ content.animation.from }}'],
            ['name' => 'data-distance', 'template' => '{{ content.animation.distance.style }}'],
            ['name' => 'data-skew', 'template' => '{{ content.animation.skew }}'],
