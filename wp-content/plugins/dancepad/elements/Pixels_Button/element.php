...
if(get_option('dan_pixels_button_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\PixelsButton",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class PixelsButton extends \Breakdance\Elements\Element
{
