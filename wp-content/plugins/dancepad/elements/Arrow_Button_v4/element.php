...
if(get_option('dan_arrow_button_v4_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\ArrowButtonV4",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class ArrowButtonV4 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Arrow Button V4';
    }

    static function className()
    {
        return 'dan-arrow-button-v4';
    }
    ...
    static function designControls()
    {
      ...
      "typography",
       ['type' => 'popout']
        ...
        "duplicated_arrow_styles",
        "Duplicated Arrow styles",
        [c(
        "type",
        "Type",
        [],
