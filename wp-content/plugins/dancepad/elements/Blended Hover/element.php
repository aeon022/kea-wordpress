...
if(get_option('dan_blended_hover_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\BlendedHover",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class BlendedHover extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Blended Hover';
        }
    
        static function className()
        {
            return 'dan-blended-hover';
        }
        ...
        static function dependencies()
        {
            return [
                '0' =>  [
                    'title' => 'Dancepad - Blended Hover',
                    'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Blended Hover/dancepad_blended_hover.min.js?ver=' . DANCEPAD_VERSION],
                ],
                '1' =>  [
                    'title' => 'Init Builder',
                    'inlineScripts' => ['dancepad_blended_hover();'],
    ...
    'onPropertyChange' => [['script' => 'dancepad_blended_hover();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_blended_hover();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_blended_hover();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_blended_hover();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_blended_hover();',
    ],],];
        }
