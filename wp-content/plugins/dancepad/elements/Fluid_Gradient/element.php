...
if(get_option('dan_fluid_gradient_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\FluidGradient",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class FluidGradient extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Fluid Gradient';
        }
    
        static function className()
        {
            return 'dan-fluid-gradient';
        }
        ...
        {
            return ['0' =>  ['title' => 'Dancepad - Fluid Gradient','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Fluid_Gradient/dancepad_fluid_gradient.min.js?ver=' . DANCEPAD_VERSION],],'1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_fluid_gradient();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],'2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_fluid_gradient();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],];
        }
    ...
    'onPropertyChange' => [['script' => 'dancepad_fluid_gradient();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_fluid_gradient();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_fluid_gradient();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_fluid_gradient();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_fluid_gradient();',
    ],],];
        }
        ...
        {
            return [['accepts' => 'string', 'path' => 'content.animation.distance'], ['accepts' => 'string', 'path' => 'content.content.text'], ['accepts' => 'string', 'path' => 'content.content.prefix'], ['accepts' => 'string', 'path' => 'content.content.suffix']];
        }
