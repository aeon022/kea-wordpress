...
if(get_option('dan_image_reveal_v2_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\ImageRevealV2",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class ImageRevealV2 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Image Reveal V2';
    }

    static function className()
    {
        return 'dan-image-reveal-v2';
    }
    ...
    {
        return ['design' => ['mask' => ['color' => '#333'], 'size' => ['width' => ['breakpoint_base' => ['number' => 400, 'unit' => 'px', 'style' => '400px']], 'height' => ['breakpoint_base' => ['number' => 400, 'unit' => 'px', 'style' => '400px']]]], 'content' => ['animation' => ['direction' => 'bottom', 'image_duration' => ['number' => 2, 'unit' => 's', 'style' => '2s'], 'image_delay' => ['number' => 1, 'unit' => 's', 'style' => '1s'], 'image_gsap_easing' => 'expo', 'mask_duration' => ['number' => 0.5, 'unit' => 's', 'style' => '0.5s'], 'mask_delay' => ['number' => 0.7, 'unit' => 's', 'style' => '0.7s'], 'mask_gsap_easing' => 'sine'], 'scrolltrigger' => ['trigger' => 'this', 'start' => 'top bottom', 'toggleactions' => 'play none none none', 'end' => 'unset', 'scrub' => '0', 'additional_triggers' => null], 'content' => ['source' => ['id' => -1, 'type' => 'external_image', 'url' => 'https://dancepad.io/wp-content/uploads/2024/11/dancepad-buttons.png', 'alt' => '', 'caption' => ''], 'source_dynamic_meta' => null]]];
    }
    ...
    static function dependencies()
    {
        return [
            '0' => [
                'title' => 'Dancepad - Image Reveal V2',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Image_Reveal_v2/dancepad_image_reveal_v2.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' => [
                'title' => 'Init Builder',
                'inlineScripts' => ['dancepad_image_reveal_v2();'],
...
'onPropertyChange' => [['script' => 'dancepad_image_reveal_v2();',
],],

'onCreatedElement' => [['script' => 'dancepad_image_reveal_v2();',
],],

'onMountedElement' => [['script' => 'dancepad_image_reveal_v2();',
],],

'onMovedElement' => [['script' => 'dancepad_image_reveal_v2();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_image_reveal_v2();',
],],];
    }
...
{% else %}
0
{% endif %}'], ['name' => 'data-from', 'template' => '{{ content.animation.direction }}'], ['name' => 'data-trigger', 'template' => '{{ content.scrolltrigger.trigger }}'], ['name' => 'data-start', 'template' => '{{ content.scrolltrigger.start }}'], ['name' => 'data-end', 'template' => '{{ content.scrolltrigger.end }}'], ['name' => 'data-scrub', 'template' => '{{ content.scrolltrigger.scrub }}'], ['name' => 'data-toggle-actions', 'template' => '{{ content.scrolltrigger.toggleactions }}'], ['name' => 'data-mask-duration', 'template' => '{{ content.animation.mask_duration.style }}'], ['name' => 'data-mask-delay', 'template' => '{{ content.animation.mask_delay.style }}'], ['name' => 'data-mask-ease', 'template' => '{{ content.animation.mask_gsap_easing }}'], ['name' => 'data-image-duration', 'template' => '{{ content.animation.image_duration.style }}'], ['name' => 'data-image-delay', 'template' => '{{ content.animation.image_delay.style }}'], ['name' => 'data-image-ease', 'template' => '{{ content.animation.image_gsap_easing }}'], ['name' => 'data-animationType', 'template' => '{{ content.scrolltrigger.additional_triggers }}'], ['name' => 'data-classTriggerClick', 'template' => '{{ content.scrolltrigger.element }}'], ['name' => 'data-classTriggerHover', 'template' => '{{ content.scrolltrigger.element }}'], ['name' => 'data-remove-scroll', 'template' => '{% if content.scrolltrigger.disable_on_scroll %}
1
{% else %}
0
{% endif %}'], ['name' => 'data-flickering', 'template' => '1']];
    }
