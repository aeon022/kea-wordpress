...
if(get_option('dan_mask_button_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\MaskButton",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class MaskButton extends \Breakdance\Elements\Element
    {
        ...
        static function designControls()
        {
          ...
          "typography",
           ['type' => 'popout']
            ...
            "Dimensions",
            [],
            ['type' => 'unit', 'layout' => 'inline', 'textOptions' => ['multiline' => true], 'unitOptions' => ['types' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'svw', 'svh', 'auto', 'custom']]],
            false,
            false,
            [],
          ), c(
        ...
        static function contentControls()
        {
            ...
            "Mix blend mode",
            [],
            ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => 'difference', 'text' => 'difference'], ['text' => 'exclusion', 'value' => 'exclusion'], ['text' => 'normal', 'value' => 'normal'], ['text' => 'screen', 'value' => 'screen'], ['text' => 'lighten', 'value' => 'lighten'], ['text' => 'hard-light', 'value' => 'hard-light'], ['text' => 'luminosity', 'value' => 'luminosity']]],
            false,
            false,
            [],
          ), c(
        ...
        {
            return ['0' =>  ['title' => 'Dancepad - Mask Button','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Mask_Button/dancepad_mask_button.min.js?ver=' . DANCEPAD_VERSION],],'1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_mask_button();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],'2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_mask_button();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],];
        }
    ...
    'onPropertyChange' => [['script' => 'dancepad_mask_button();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_mask_button();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_mask_button();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_mask_button();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_mask_button();',
    ],],];
        }
