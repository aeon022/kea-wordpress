...
if(get_option('dan_interactive_lines_v2_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\Interactive_Lines_v2",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class Interactive_Lines_v2 extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Interactive Lines V2';
        }
    
        static function className()
        {
            return 'dan-interactive-lines-v2';
        }
        ...
        {
            return ['design' => ['background' => ['color' => ['breakpoint_base' => '#000000']], 'size' => ['width' => ['breakpoint_base' => ['number' => 100, 'unit' => '%', 'style' => '100%']], 'height' => ['breakpoint_base' => ['number' => 500, 'unit' => 'px', 'style' => '500px']]], 'lines' => ['spacing' => 30, 'width' => ['number' => 1, 'unit' => 'px', 'style' => '1px'], 'height' => ['number' => 10, 'unit' => 'px', 'style' => '10px'], 'color' => 'rgba(255, 255, 255, 0.3)'], 'ball' => ['dimensions' => ['number' => 6, 'unit' => 'px', 'style' => '6px'], 'size' => ['number' => 6, 'unit' => 'px', 'style' => '6px'], 'color' => '#fff', 'border' => ['radius' => ['breakpoint_base' => ['all' => ['number' => 50, 'unit' => '%', 'style' => '50%'], 'topLeft' => ['number' => 50, 'unit' => '%', 'style' => '50%'], 'topRight' => ['number' => 50, 'unit' => '%', 'style' => '50%'], 'bottomLeft' => ['number' => 50, 'unit' => '%', 'style' => '50%'], 'bottomRight' => ['number' => 50, 'unit' => '%', 'style' => '50%'], 'editMode' => 'all']]]]], 'content' => ['animation' => ['gsap_easing' => 'expo', 'duration' => ['number' => 1, 'unit' => 's', 'style' => '1s']]]];
        }
    
        static function defaultChildren()
        {
            return [['slug' => 'EssentialElements\Div', 'defaultProperties' => ['meta' => ['friendlyName' => 'Content'], 'settings' => ['advanced' => ['css' => ['breakpoint_base' => null], 'classes' => null]], 'design' => ['layout_v2' => ['layout' => 'vertical', 'v_vertical_align' => ['breakpoint_base' => 'center'], 'v_align' => ['breakpoint_base' => 'center']], 'container' => ['min_height' => ['breakpoint_base' => ['number' => 100, 'unit' => '%', 'style' => '100%']]]]], 'children' => [['slug' => 'EssentialElements\Text', 'defaultProperties' => ['content' => ['content' => ['text' => 'Interactive Lines v2']], 'design' => ['typography' => ['color' => ['breakpoint_base' => '#fff'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => ['number' => 32, 'unit' => 'px', 'style' => '32px']], 'fontWeight' => ['breakpoint_base' => '500']]]]]]], 'children' => []]]]];
        }
        ...
        static function dependencies()
        {
            return [
                '0' => [
                    'title' => 'Dancepad - Interactive Lines v2',
                    'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Interactive_Lines_v2/dancepad_interactive_lines_v2.min.js?ver=' . DANCEPAD_VERSION],
                ],
                '1' => [
                    'title' => 'Init Builder',
                    'inlineScripts' => ['dancepad_interactive_lines_v2();'],
    ...
    'onPropertyChange' => [['script' => 'dancepad_interactive_lines_v2();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_interactive_lines_v2();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_interactive_lines_v2();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_interactive_lines_v2();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_interactive_lines_v2();',
    ],],];
        }
    ...
    {% else %}
    0
    {% endif %}'], ['name' => 'data-duration', 'template' => '{{ content.animation.duration.style }}'], ['name' => 'data-ease', 'template' => '{{ content.animation.gsap_easing }}'], ['name' => 'data-spacing', 'template' => '{{ design.lines.spacing }}'], ['name' => 'data-stroke-length', 'template' => '{{ design.lines.height.style }}'], ['name' => 'data-stroke-width', 'template' => '{{ design.lines.width.style }}']];
        }
