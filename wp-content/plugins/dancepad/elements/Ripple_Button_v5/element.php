...
if(get_option('dan_ripple_button_v5_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\RippleButtonV5",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class RippleButtonV5 extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Ripple Button V5';
        }
    
        static function className()
        {
            return 'dan-ripple-button-v5';
        }
