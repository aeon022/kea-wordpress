...
if(get_option('dan_arrow_button_v3_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\ArrowButtonv3",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class ArrowButtonv3 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Arrow Button v3';
    }

    static function className()
    {
        return 'dan-arrow-button-v3';
    }
