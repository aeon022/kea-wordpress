...
if(get_option('dan_arrow_button_v6_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\ArrowButtonV6",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class ArrowButtonV6 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Arrow Button V6';
    }

    static function className()
    {
        return 'dan-arrow-button-v6';
    }
