...
if(get_option('dan_arrow_button_v5_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\ArrowButtonV5",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class ArrowButtonV5 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Arrow Button V5';
    }

    static function className()
    {
        return 'dan-arrow-button-v5';
    }
    ...
    static function designControls()
    {
      ...
      "typography",
       ['type' => 'popout']
        ...
        "duplicated_arrow_left",
        "Duplicated Arrow Left",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'svw', 'svh', 'auto', 'custom']]],
        true,
        false,
    ...
    {
        return ['content.content.text', 'design.layout.horizontal.vertical_at'];
    }
