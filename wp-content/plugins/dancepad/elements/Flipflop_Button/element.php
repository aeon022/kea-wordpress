...
if(get_option('dan_flipflop_button_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\FlipflopButton",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class FlipflopButton extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Flipflop Button';
        }
    
        static function className()
        {
            return 'dan-flipflop-button';
        }
        ...
        {
            return [['name' => 'data-text', 'template' => '{{ content.content.blurry_text }}']];
        }
