...
if(get_option('dan_stretchy_button_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\StretchyButton",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class StretchyButton extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Stretchy Button';
        }
    
        static function className()
        {
            return 'dan-stretchy-button';
        }
