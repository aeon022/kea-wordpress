...
if(get_option('dan_circular_menu_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\CircularMenu",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class CircularMenu extends \Breakdance\Elements\Element
    {
        ...
        static function dependencies()
        {
            return [
                '0' =>  [
                    'title' => 'Dancepad - Circular Menu',
                    'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Circular_Menu/dancepad_circular_menu.min.js?ver=' . DANCEPAD_VERSION],
                ],
                '1' =>  [
                    'title' => 'Init Builder', 
                    'inlineScripts' => [
                        'dancepad_circular_menu();'
                    ],
    ...
    'onPropertyChange' => [['script' => 'dancepad_circular_menu();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_circular_menu();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_circular_menu();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_circular_menu();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_circular_menu();',
    ],],];
        }
