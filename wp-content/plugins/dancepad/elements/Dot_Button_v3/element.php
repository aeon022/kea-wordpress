...
if(get_option('dan_dot_button_v3_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\DotButtonV3",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class DotButtonV3 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Dot Button V3';
    }

    static function className()
    {
        return 'dan-dot-button-v3';
    }
    ...
    {
        return [['accepts' => 'image_url', 'path' => 'design.blurry_background.layers[].image'], ['accepts' => 'image_url', 'path' => 'design.dots.second_dot_color.layers[].image'], ['accepts' => 'image_url', 'path' => 'design.dots.third_dot_color.layers[].image']];
    }
