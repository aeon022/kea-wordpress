...
if(get_option('dan_stripes_button_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\StripesButton",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class StripesButton extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Stripes Button';
    }

    static function className()
    {
        return 'dan-stripes-button';
    }
    ...
    {
        return [['accepts' => 'image_url', 'path' => 'design.blurry_background.layers[].image'], ['accepts' => 'image_url', 'path' => 'design.colors.background.layers[].image']];
    }
