...
if(get_option('dan_ripple_button_v3_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\RippleButtonV3",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class RippleButtonV3 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Ripple Button v3';
    }

    static function className()
    {
        return 'dan-ripple-button-v3';
    }
    ...
    {
        return ['0' =>  ['title' => 'Dancepad - Ripple Button v3','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Ripple_Button_v3/dancepad_ripple_button_v3.min.js?ver=' . DANCEPAD_VERSION],],'1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_ripple_button_v3();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],'2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_ripple_button_v3();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],];
    }
...
'onPropertyChange' => [['script' => 'dancepad_ripple_button_v3();',
],],

'onCreatedElement' => [['script' => 'dancepad_ripple_button_v3();',
],],

'onMountedElement' => [['script' => 'dancepad_ripple_button_v3();',
],],

'onMovedElement' => [['script' => 'dancepad_ripple_button_v3();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_ripple_button_v3();',
],],];
    }
