...
if(get_option('dan_reel_button_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\ReelButton",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class ReelButton extends \Breakdance\Elements\Element
    {
        ...
        static function designControls()
        {
          ...
          "typography",
           ['type' => 'popout']
            ...
            "Translate",
            [],
            ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', 'em', '%', 'rem', 'vw', 'svw', 'custom']]],
            false,
            false,
            [],
          ), c(
