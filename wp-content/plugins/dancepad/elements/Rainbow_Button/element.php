...
if(get_option('dan_rainbow_button_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\RainbowButton",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class RainbowButton extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Rainbow Button';
    }

    static function className()
    {
        return 'dan-rainbow-button';
    }
    ...
    {
        return ['content' => ['content' => ['text' => 'Rainbow Button', 'tag' => 'div'], 'rainbow_animation' => ['duration' => ['number' => 12, 'unit' => 's', 'style' => '12s'], 'css_easing' => 'linear']], 'design' => ['padding' => ['padding' => ['breakpoint_base' => ['top' => ['number' => 8, 'unit' => 'px', 'style' => '8px'], 'bottom' => ['number' => 8, 'unit' => 'px', 'style' => '8px'], 'left' => ['number' => 12, 'unit' => 'px', 'style' => '12px'], 'right' => ['number' => 12, 'unit' => 'px', 'style' => '12px']]]], 'typography' => ['color' => ['breakpoint_base' => '#fff'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => ['number' => 14, 'unit' => 'px', 'style' => '14px']]]]]], 'button_colors' => ['background' => '#000', 'rainbow_base_color' => '#F47373'], 'border' => ['border_color' => '#333333', 'border_width' => ['number' => 3, 'unit' => 'px', 'style' => '3px'], 'border_radius' => ['number' => 8, 'unit' => 'px', 'style' => '8px']]]];
    }
    ...
    static function designControls()
    {
      ...
      "typography",
       ['type' => 'popout']
        ...
        "Border width",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', 'em', 'rem', '%', 'vh', 'custom']]],
        false,
        false,
        [],
      ), c(
    ...
    {
        return [['name' => 'data-always-play', 'template' => '{% if content.rainbow_animation.always_play %}
1
{% else %}
0
{% endif %}']];
