...
if(get_option('dan_prism_button_v2_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\PrismButtonV2",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class PrismButtonV2 extends \Breakdance\Elements\Element
    {
