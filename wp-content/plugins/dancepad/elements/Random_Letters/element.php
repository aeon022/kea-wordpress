...
if(get_option('dan_random_letters_enable') == 'true') {
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\RandomLetters",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class RandomLetters extends \Breakdance\Elements\Element
{
    ...
    static function dependencies()
    {
        return [
            '0' =>  [
                'title' => 'Dancepad - Random Letters',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Random_Letters/dancepad_random_letters.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' =>  [
                'title' => 'Init Builder',
                'inlineScripts' => [
                    'dancepad_random_letters();'
                ],
...
'onPropertyChange' => [['script' => 'dancepad_random_letters();',
],],

'onCreatedElement' => [['script' => 'dancepad_random_letters();',
],],

'onMountedElement' => [['script' => 'dancepad_random_letters();',
],],

'onMovedElement' => [['script' => 'dancepad_random_letters();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_random_letters();',
],],];
    }
