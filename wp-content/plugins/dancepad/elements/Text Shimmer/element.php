...
if(get_option('dan_text_shimmer_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\TextShimmer",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class TextShimmer extends \Breakdance\Elements\Element
    {
        ...
        {
            return [
                '0' =>  ['title' => 'Dancepad - Text Shimmer','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Text Shimmer/dancepad_text_shimmer.min.js?ver=' . DANCEPAD_VERSION],],
                '1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_text_shimmer();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],
                '2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_text_shimmer();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],
    ...
    'onPropertyChange' => [['script' => 'dancepad_text_shimmer();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_text_shimmer();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_text_shimmer();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_text_shimmer();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_text_shimmer();',
    ],],];
        }
