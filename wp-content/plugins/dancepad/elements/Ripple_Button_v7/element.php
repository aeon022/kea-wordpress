...
if(get_option('dan_ripple_button_v7_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\RippleButtonV7",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class RippleButtonV7 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Ripple Button V7';
    }

    static function className()
    {
        return 'dan-ripple-button-v7';
    }
    ...
    {
        return [['name' => 'data-text', 'template' => '{{ content.content.text }}'], ['name' => 'data-mask-to', 'template' => '{{ content.ripple_animation.from }}'], ['name' => 'data-text-to', 'template' => '{{ content.swap_animation.from }}']];
    }
    ...
    {
        return [['accepts' => 'image_url', 'path' => 'design.blurry_background.layers[].image'], ['accepts' => 'image_url', 'path' => 'design.background.layers[].image']];
    }
