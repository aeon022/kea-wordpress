...
if(get_option('dan_ripple_button_v6_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\RippleButtonV6",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class RippleButtonV6 extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Ripple Button V6';
        }
    
        static function className()
        {
            return 'dan-ripple-button-v6';
        }
