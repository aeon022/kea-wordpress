...
if(get_option('dan_progress_bar_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\ProgressBar",
    ...
    class ProgressBar extends \Breakdance\Elements\Element
    {
        ...
        {
            return ['design' => ['spacing' => ['zindex' => 9999, 'right' => ['number' => 75, 'unit' => 'px', 'style' => '75px'], 'bottom' => ['number' => 50, 'unit' => 'px', 'style' => '50px']], 'progress' => ['path_color' => '#0080ff3f', 'fill_color' => '#007fff', 'width' => ['breakpoint_base' => ['number' => 1, 'unit' => 'px', 'style' => '1px']], 'height' => ['breakpoint_base' => ['number' => 100, 'unit' => 'px', 'style' => '100px']]], 'number' => ['top' => ['breakpoint_base' => ['number' => -15, 'unit' => 'px', 'style' => '-15px']], 'left' => ['breakpoint_base' => ['number' => 10, 'unit' => 'px', 'style' => '10px']], 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['number' => 14, 'unit' => 'px', 'style' => '14px']]], 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => ['number' => 14, 'unit' => 'px', 'style' => '14px']]]]], 'color' => ['breakpoint_base' => '#007fff']]], 'position' => ['right' => ['breakpoint_base' => ['number' => 75, 'unit' => 'px', 'style' => '75px']], 'bottom' => ['breakpoint_base' => ['number' => 50, 'unit' => 'px', 'style' => '50px']], 'zindex' => 9999]]];
        }
        ...
        static function designControls()
        {
          ...
          "typography",
           ['type' => 'popout']
            ...
            "Note",
            [],
            ['type' => 'alert_box', 'layout' => 'vertical', 'alertBoxOptions' => ['style' => 'default', 'content' => '<p>Number position is relative to the progress bar.</p>']],
            false,
            false,
            [],
          ), c(
        ...
        {
            return ['0' =>  ['title' => 'Dancepad - Progress Bar','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Progress_Bar/dancepad_progress_bar.min.js?ver=' . DANCEPAD_VERSION],],'1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_progress_bar();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],'2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_progress_bar();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],];
        }
    ...
    'onPropertyChange' => [['script' => 'dancepad_progress_bar();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_progress_bar();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_progress_bar();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_progress_bar();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_progress_bar();',
    ],],];
        }
        ...
        {
            return [['name' => 'data-scroll-to-pixel', 'template' => '{{ content.back_to_top.scroll_to.style }}'], ['name' => 'data-back-duration', 'template' => '{{ content.back_to_top.duration.style }}'], ['name' => 'data-back-easing', 'template' => '{{ content.back_to_top.gsap_easing }}'], ['name' => 'data-speed', 'template' => '{{ content.animation.speed }}'], ['name' => 'data-ease', 'template' => '{{ content.animation.progress_css_easing }}'], ['name' => 'data-entrance-distance', 'template' => '{{ content.animation.entrance_distance.style }}']];
        }
