...
if(get_option('dan_image_reveal_v4_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\ImageRevealV4",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class ImageRevealV4 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Image Reveal V4';
    }

    static function className()
    {
        return 'dan-image-reveal-v4';
    }
    ...
    {
        return ['design' => ['size' => ['width' => ['breakpoint_base' => ['number' => 400, 'unit' => 'px', 'style' => '400px']], 'height' => ['breakpoint_base' => ['number' => 400, 'unit' => 'px', 'style' => '400px']]], 'squares' => ['color' => '#000000', 'number' => 12]], 'content' => ['animation' => ['duration' => ['number' => 1, 'unit' => 's', 'style' => '1s'], 'stagger' => ['number' => 0.005, 'unit' => 's', 'style' => '0.005s'], 'delay' => ['number' => 0.2, 'unit' => 's', 'style' => '0.2s'], 'gsap_easing' => 'expo'], 'scrolltrigger' => ['trigger' => 'this', 'start' => 'top bottom', 'end' => 'unset', 'scrub' => '0', 'toggleactions' => 'play none none none'], 'content' => ['source' => ['id' => -1, 'type' => 'external_image', 'url' => 'https://dancepad.io/wp-content/uploads/2024/11/dancepad-buttons.png', 'alt' => '', 'caption' => '']]]];
    }
    ...
    static function dependencies()
    {
        return [
            '0' => [
                'title' => 'Dancepad - Image Reveal V4',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Image_Reveal_v4/dancepad_image_reveal_v4.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' => [
                'title' => 'Init Builder',
                'inlineScripts' => ['dancepad_image_reveal_v4();'],
...
'onPropertyChange' => [['script' => 'dancepad_image_reveal_v4();',
],],

'onCreatedElement' => [['script' => 'dancepad_image_reveal_v4();',
],],

'onMountedElement' => [['script' => 'dancepad_image_reveal_v4();',
],],

'onMovedElement' => [['script' => 'dancepad_image_reveal_v4();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_image_reveal_v4();',
],],];
    }
...
{% else %}
0
{% endif %}'], ['name' => 'data-trigger', 'template' => '{{ content.scrolltrigger.trigger }}'], ['name' => 'data-start', 'template' => '{{ content.scrolltrigger.start }}'], ['name' => 'data-end', 'template' => '{{ content.scrolltrigger.end }}'], ['name' => 'data-scrub', 'template' => '{{ content.scrolltrigger.scrub }}'], ['name' => 'data-toggle-actions', 'template' => '{{ content.scrolltrigger.toggleactions }}'], ['name' => 'data-duration', 'template' => '{{ content.animation.duration.style }}'], ['name' => 'data-delay', 'template' => '{{ content.animation.delay.style }}'], ['name' => 'data-ease', 'template' => '{{ content.animation.gsap_easing }}'], ['name' => 'data-animationType', 'template' => '{{ content.scrolltrigger.additional_triggers }}'], ['name' => 'data-classTriggerClick', 'template' => '{{ content.scrolltrigger.element }}'], ['name' => 'data-classTriggerHover', 'template' => '{{ content.scrolltrigger.element }}'], ['name' => 'data-remove-scroll', 'template' => '{% if content.scrolltrigger.disable_on_scroll %}
1
{% else %}
0
{% endif %}'], ['name' => 'data-flickering', 'template' => '1'], ['name' => 'data-squares-number', 'template' => '{{ design.squares.number }}'], ['name' => 'data-stagger', 'template' => '{{ content.animation.stagger.style }}']];
    }
