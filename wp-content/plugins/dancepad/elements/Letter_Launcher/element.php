...
if(get_option('dan_letter_launcher_enable') == 'true') {
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\LetterLauncher",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class LetterLauncher extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Letter Launcher';
    }

    static function className()
    {
        return 'dan-letter-launcher';
    }
    ...
    {
        return ['content' => ['content' => ['text' => 'Letter Launcher', 'tag' => 'span', 'link' => null], 'animation' => ['duration' => ['number' => 0.6, 'unit' => 's', 'style' => '0.6s'], 'distance' => ['number' => 100, 'unit' => '%', 'style' => '100%'], 'split_type' => 'lines', 'from' => 'bottom', 'distance_dynamic_meta' => null, 'skew' => 0, 'stagger' => 0.05, 'delay' => ['number' => 0, 'unit' => 's', 'style' => '0s'], 'gsap_easing' => 'power3', 'perspective' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'rotation' => ['number' => 30, 'unit' => 'deg', 'style' => '30deg'], 'altitude' => ['number' => 20, 'unit' => 'px', 'style' => '20px']], 'scrolltrigger' => ['additional_triggers' => null, 'trigger' => 'this', 'start' => 'top bottom', 'end' => 'unset', 'toggleactions' => 'play none none none']], 'design' => ['typography' => ['text' => ['custom' => ['customTypography' => ['fontFamily' => null, 'fontSize' => ['number' => 75, 'unit' => 'px', 'style' => '75px'], 'advanced' => ['letterSpacing' => null]]]], 'color' => null, 'color_hover' => null, 'typography' => ['custom' => ['customTypography' => ['fontFamily' => null, 'fontSize' => ['breakpoint_base' => ['number' => 20, 'unit' => 'px', 'style' => '20px']], 'fontFamily_hover' => null, 'fontSize_hover' => null]]]], 'elements_hive' => ['backlight' => ['enabled' => false]], 'style' => ['new_control' => ['label' => 'Preset 0', 'id' => 'preset-id-72d05461-b30c-4ca4-be1a-3a678f1d3fcf'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => null, 'fontFamily' => null]]]]]];
    }
    ...
    static function dependencies()
    {
        return [
            '0' =>  [
                'title' => 'Dancepad - Letter Launcher',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Letter_Launcher/dancepad_letter_launcher.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' =>  [
                'title' => 'Init Builder',
                'inlineScripts' => [
                    'dancepad_letter_launcher();'
                ],
...
'onPropertyChange' => [['script' => 'dancepad_letter_launcher();',
],],

'onCreatedElement' => [['script' => 'dancepad_letter_launcher();',
],],

'onMountedElement' => [['script' => 'dancepad_letter_launcher();',
],],

'onMovedElement' => [['script' => 'dancepad_letter_launcher();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_letter_launcher();',
],],];
    }
    ...
    static function attributes()
    {
        return [
            ...
            ['name' => 'data-rotation', 'template' => '{{ content.animation.rotation.style }}'],
            ['name' => 'data-altitude', 'template' => '{{ content.animation.altitude.style }}'],
