...
if(get_option('dan_infinite_slider_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\InfiniteSlider",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class InfiniteSlider extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Infinite Slider';
        }
    
        static function className()
        {
            return 'dan-infinite-slider';
        }
        ...
        {
            return ['design' => ['dimensions' => ['width' => ['number' => 100, 'unit' => '%', 'style' => '100%'], 'viewport_gap' => ['number' => 5, 'unit' => 'vw', 'style' => '5vw']], 'items_style' => ['width' => ['number' => 40, 'unit' => 'vw', 'style' => '40vw'], 'height' => ['number' => 500, 'unit' => 'px', 'style' => '500px']]]];
        }
    
        static function defaultChildren()
        {
            return [['slug' => 'EssentialElements\Div', 'defaultProperties' => ['meta' => ['friendlyName' => 'Slider Item'], 'settings' => ['advanced' => ['classes' => ['dan-infinite-slider__item']]]], 'children' => [['slug' => 'EssentialElements\Image2', 'defaultProperties' => ['content' => ['image' => ['from' => 'url', 'lazy_load' => true, 'alt' => 'from_media_library', 'url' => 'https://nextbricks.io/wp-content/uploads/2024/09/cursor_slide_1.webp']]], 'children' => []]]], ['slug' => 'EssentialElements\Div', 'defaultProperties' => ['meta' => ['friendlyName' => 'Slider Item'], 'settings' => ['advanced' => ['classes' => ['dan-infinite-slider__item']]]], 'children' => [['slug' => 'EssentialElements\Image2', 'defaultProperties' => ['content' => ['image' => ['from' => 'url', 'lazy_load' => true, 'alt' => 'from_media_library', 'url' => 'https://nextbricks.io/wp-content/uploads/2024/09/cursor_slide_2.webp']]], 'children' => []]]], ['slug' => 'EssentialElements\Div', 'defaultProperties' => ['meta' => ['friendlyName' => 'Slider Item'], 'settings' => ['advanced' => ['classes' => ['dan-infinite-slider__item']]]], 'children' => [['slug' => 'EssentialElements\Image2', 'defaultProperties' => ['content' => ['image' => ['from' => 'url', 'lazy_load' => true, 'alt' => 'from_media_library', 'url' => 'https://nextbricks.io/wp-content/uploads/2024/09/cursor_slide_3.webp']]], 'children' => []]]], ['slug' => 'EssentialElements\Div', 'defaultProperties' => ['meta' => ['friendlyName' => 'Slider Item'], 'settings' => ['advanced' => ['classes' => ['dan-infinite-slider__item']]]], 'children' => [['slug' => 'EssentialElements\Image2', 'defaultProperties' => ['content' => ['image' => ['from' => 'url', 'lazy_load' => true, 'alt' => 'from_media_library', 'url' => 'https://nextbricks.io/wp-content/uploads/2024/09/cursor_slide_4.webp']]], 'children' => []]]]];
        }
        ...
        static function designControls()
        {
          ...
          "margin",
           ['type' => 'popout']
            ...
            "Viewport Gap",
            [],
            ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['vw']]],
            true,
            false,
            [],
          )],
        ...
        {
            return [
                '0' =>  ['title' => 'Dancepad - Infinite Slider','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Infinite Slider/dancepad_infinite_slider.min.js?ver=' . DANCEPAD_VERSION],],
                '1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_infinite_slider();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],
                '2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_infinite_slider();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],
    ...
    'onPropertyChange' => [['script' => 'dancepad_infinite_slider();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_infinite_slider();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_infinite_slider();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_infinite_slider();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_infinite_slider();',
    ],],];
        }
