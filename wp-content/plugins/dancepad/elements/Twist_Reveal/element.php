...
if(get_option('dan_twist_reveal_enable') == 'true') {
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\TwistReveal",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class TwistReveal extends \Breakdance\Elements\Element
{
    ...
    static function dependencies()
    {
        return [
            '0' =>  [
                'title' => 'Dancepad - Twist Reveal',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Twist_Reveal/dancepad_twist_reveal.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' =>  [
                'title' => 'Init Builder',
                'inlineScripts' => [
                    'dancepad_twist_reveal();'
                ],
...
'onPropertyChange' => [['script' => 'dancepad_twist_reveal();',
],],

'onCreatedElement' => [['script' => 'dancepad_twist_reveal();',
],],

'onMountedElement' => [['script' => 'dancepad_twist_reveal();',
],],

'onMovedElement' => [['script' => 'dancepad_twist_reveal();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_twist_reveal();',
],],];
    }
