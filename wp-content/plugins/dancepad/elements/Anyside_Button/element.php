...
if(get_option('dan_anyside_button') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\AnysideButton",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class AnysideButton extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Anyside Button';
    }

    static function className()
    {
        return 'dan-anyside-button';
    }
    ...
    static function designControls()
    {
      ...
      "typography",
       ['type' => 'popout']
        ...
        "Click dimensions",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'textOptions' => ['multiline' => true]],
        false,
        false,
        [],
      ), c(
    ...
    {
        return ['0' =>  ['title' => 'Dancepad - Anyside Button','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Anyside_Button/dancepad_anyside_button.min.js?ver=' . DANCEPAD_VERSION],],'1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_anyside_button();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],'2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_anyside_button();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],];
    }
...
'onPropertyChange' => [['script' => 'dancepad_anyside_button();',
],],

'onCreatedElement' => [['script' => 'dancepad_anyside_button();',
],],

'onMountedElement' => [['script' => 'dancepad_anyside_button();',
],],

'onMovedElement' => [['script' => 'dancepad_anyside_button();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_anyside_button();',
],],];
    }
    ...
    {
        return [['name' => 'data-durationclick', 'template' => '{{ content.animation.path_in_duration.style }}'], ['name' => 'data-type', 'template' => '{{ content.animation.event }}']];
    }
