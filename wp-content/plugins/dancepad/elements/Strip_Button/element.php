...
if(get_option('dan_strip_button_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\StripButton",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class StripButton extends \Breakdance\Elements\Element
    {
        ...
        {
            return [['name' => 'data-from', 'template' => '{% if content.strip_animation.from == \'left\' %}
      left
    {% elseif content.strip_animation.from == \'right\' %}
      right
    {% endif %}']];
        }
