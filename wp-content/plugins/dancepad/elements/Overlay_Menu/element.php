...
if(get_option('dan_overlay_menu_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\OverlayMenu",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class OverlayMenu extends \Breakdance\Elements\Element
    {
        ...
        static function contentControls()
        {
            ...
            "Duration",
            [],
            ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['s']], 'condition' => [[['path' => 'content.animation.enable_fade', 'operand' => 'is set', 'value' => '']]]],
            false,
            false,
            [],
          ), c(
        ...
        static function dependencies()
        {
            return [
                '0' =>  [
                    'title' => 'Dancepad - Overlay Menu',
                    'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Overlay_Menu/dancepad_overlay_menu.min.js?ver=' . DANCEPAD_VERSION],
                ],
                '1' =>  [
                    'title' => 'Init Builder', 
                    'inlineScripts' => [
                        'dancepad_overlay_menu();'
                    ],
    ...
    'onPropertyChange' => [['script' => 'dancepad_overlay_menu();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_overlay_menu();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_overlay_menu();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_overlay_menu();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_overlay_menu();',
    ],],];
        }
