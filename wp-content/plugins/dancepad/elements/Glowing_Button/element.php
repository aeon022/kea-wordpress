...
if(get_option('dan_glowing_button_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\GlowingButton",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class GlowingButton extends \Breakdance\Elements\Element
    {
