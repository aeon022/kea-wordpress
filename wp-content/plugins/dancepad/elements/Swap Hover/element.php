...
if(get_option('dan_swap_hover_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\SwapHover",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class SwapHover extends \Breakdance\Elements\Element
    {
        ...
        static function contentControls()
        {
            ...
            "Split type",
            [],
            ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['text' => 'chars', 'value' => 'chars'], ['text' => 'words', 'value' => 'words'], ['value' => 'lines', 'text' => 'lines']]],
            false,
            false,
            [],
          ), c(
            ...
            "Swapped Text",
            [],
            ['type' => 'text', 'layout' => 'vertical', 'textOptions' => ['multiline' => true, 'format' => 'plain'], 'autofocus' => true, 'condition' => [[['path' => 'content.animation.split_type', 'operand' => 'equals', 'value' => 'lines']]]],
            false,
            false,
            [],
          ), c(
            ...
            "From",
            [],
            ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => '-1', 'text' => 'Top'], ['text' => 'Bottom', 'value' => '1']]],
            false,
            false,
            [],
          ), c(
        ...
        {
            return [
                '0' =>  ['title' => 'Dancepad - Swap Hover','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Swap Hover/dancepad_swap_hover.min.js?ver=' . DANCEPAD_VERSION],],
                '1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_swap_hover();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],
                '2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_swap_hover();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],
    ...
    'onPropertyChange' => [['script' => 'dancepad_swap_hover();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_swap_hover();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_swap_hover();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_swap_hover();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_swap_hover();',
    ],],];
        }
        ...
        {
            return [['name' => 'data-type', 'template' => '{{ content.animation.split_type }}'], ['name' => 'data-inner', 'template' => '{{ content.animation.swapped_text }}'], ['name' => 'data-stagger', 'template' => '{{ content.animation.stagger }}'], ['name' => 'data-content', 'template' => '{{ content.content.text }}']];
        }
