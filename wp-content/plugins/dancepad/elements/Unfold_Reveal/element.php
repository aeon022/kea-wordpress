...
if(get_option('dan_unfold_reveal_enable') == 'true') {
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\UnfoldReveal",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class UnfoldReveal extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Unfold Reveal';
    }

    static function className()
    {
        return 'dan-unfold-reveal';
    }
    ...
    {
        return ['content' => ['content' => ['text' => 'Unfold Reveal', 'tag' => 'span', 'link' => null], 'animation' => ['duration' => ['number' => 0.6, 'unit' => 's', 'style' => '0.6s'], 'distance' => ['number' => 100, 'unit' => '%', 'style' => '100%'], 'split_type' => 'chars', 'from' => 'bottom', 'distance_dynamic_meta' => null, 'skew' => 0, 'stagger' => 0.1, 'delay' => ['number' => 0, 'unit' => 's', 'style' => '0s'], 'gsap_easing' => 'power3', 'unfold' => ['number' => 20, 'unit' => 'px', 'style' => '20px'], 'intensity' => 600, 'direction' => 'left'], 'scrolltrigger' => ['additional_triggers' => null, 'trigger' => 'this', 'start' => 'top bottom', 'end' => 'unset', 'toggleactions' => 'play none none none', 'scrub' => false]], 'design' => ['typography' => ['text' => ['custom' => ['customTypography' => ['fontFamily' => null, 'fontSize' => ['number' => 75, 'unit' => 'px', 'style' => '75px'], 'advanced' => ['letterSpacing' => null]]]], 'color' => null, 'color_hover' => null, 'typography' => ['custom' => ['customTypography' => ['fontFamily' => null, 'fontSize' => ['breakpoint_base' => ['number' => 20, 'unit' => 'px', 'style' => '20px']], 'fontFamily_hover' => null, 'fontSize_hover' => null]]]], 'elements_hive' => ['backlight' => ['enabled' => false]], 'style' => ['new_control' => ['label' => 'Preset 0', 'id' => 'preset-id-72d05461-b30c-4ca4-be1a-3a678f1d3fcf'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => null, 'fontFamily' => null]]]], 'spacing' => null]];
    }
    ...
    static function contentControls()
    {
        ...
        "Split type",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['text' => 'chars', 'value' => 'chars'], ['text' => 'words', 'value' => 'words']]],
        false,
        false,
        [],
      ), c(
    ...
    static function dependencies()
    {
        return [
            '0' =>  [
                'title' => 'Dancepad - Unfold Reveal',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Unfold_Reveal/dancepad_unfold_reveal.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' =>  [
                'title' => 'Init Builder',
                'inlineScripts' => [
                    'dancepad_unfold_reveal();'
                ],
...
'onPropertyChange' => [['script' => 'dancepad_unfold_reveal();',
],],

'onCreatedElement' => [['script' => 'dancepad_unfold_reveal();',
],],

'onMountedElement' => [['script' => 'dancepad_unfold_reveal();',
],],

'onMovedElement' => [['script' => 'dancepad_unfold_reveal();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_unfold_reveal();',
],],];
    }
    ...
    {
        return [
            ['name' => 'data-split', 'template' => '{{ content.animation.split_type }}'],
            ['name' => 'data-stagger', 'template' => '{{ content.animation.stagger }}'],
            ['name' => 'data-duration', 'template' => '{{ content.animation.duration.style }}'],
            ['name' => 'data-delay', 'template' => '{{ content.animation.delay.style }}'],
            ['name' => 'data-easing', 'template' => '{{ content.animation.gsap_easing }}'],
            ['name' => 'data-trigger', 'template' => '{{ content.scrolltrigger.trigger }}'],
            ['name' => 'data-start', 'template' => '{{ content.scrolltrigger.start }}'],
            ['name' => 'data-end', 'template' => '{{ content.scrolltrigger.end }}'],
            ['name' => 'data-scrub', 'template' => '{{ content.scrolltrigger.scrub }}'],
            ['name' => 'data-toggleactions', 'template' => '{{ content.scrolltrigger.toggleactions }}'],
            ['name' => 'data-additional_triggers', 'template' => '{{ content.scrolltrigger.additional_triggers }}'],
            ['name' => 'data-element', 'template' => '{{ content.scrolltrigger.element }}'],
            ['name' => 'data-intensity', 'template' => '{{ content.animation.intensity }}'],
            ['name' => 'data-direction', 'template' => '{{ content.animation.direction }}'],
