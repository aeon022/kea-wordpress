...
if(get_option('dan_dot_button_v2_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\DotButtonV2",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class DotButtonV2 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Dot Button V2';
    }

    static function className()
    {
        return 'dan-dot-button-v2';
    }
