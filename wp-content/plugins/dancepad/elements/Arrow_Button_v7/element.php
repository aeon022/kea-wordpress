...
if(get_option('dan_arrow_button_v7_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\ArrowButtonV7",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class ArrowButtonV7 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Arrow Button V7';
    }

    static function className()
    {
        return 'dan-arrow-button-v7';
    }
    ...
    {
        return ['content' => ['team_members' => ['members' => [[]]], 'toasts' => ['toasts' => [['title' => 'Welcome', 'message' => 'Thanks for visiting our site!\'', 'event' => 'pageload', 'show_time' => ['number' => 5, 'unit' => 's', 'style' => '5s'], 'show_time_pageload_' => ['number' => 1, 'unit' => 's', 'style' => '1s'], 'trigger_click_' => '.test']]], 'show_toasts_animation' => ['duration' => ['number' => 0.3, 'unit' => 's', 'style' => '0.3s'], 'gsap_easing' => 'back'], 'hide_toasts_animation' => ['duration' => ['number' => 0.5, 'unit' => 's', 'style' => '0.5s'], 'gsap_easing' => 'expo'], 'expand_toasts_animation' => ['duration' => ['number' => 1, 'unit' => 's', 'style' => '1s'], 'gsap_easing' => 'expo'], 'collapse_toasts_animation' => ['duration' => ['number' => 1, 'unit' => 's', 'style' => '1s'], 'gsap_easing' => 'expo'], 'content' => ['tag' => 'div', 'text' => 'Arrow Button v7', 'swap_text' => 'Arrow Button v7'], 'animation' => ['css_easing' => 'cubic-bezier(0.76, 0, 0.24, 1)', 'duration' => ['number' => 0.5, 'unit' => 's', 'style' => '0.5s'], 'stagger' => ['number' => 0.02, 'unit' => 's', 'style' => '0.02s']], 'arrow_animation' => ['translate_from' => ['breakpoint_base' => ['number' => 3, 'unit' => 'em', 'style' => '3em']], 'translate_duration' => ['number' => 0.85, 'unit' => 's', 'style' => '0.85s'], 'animation_duration' => ['number' => 0.8, 'unit' => 's', 'style' => '0.8s'], 'css_easing' => 'cubic-bezier(0.33, 1, 0.68, 1)', 'scale' => ['breakpoint_base' => 2.3], 'duration' => ['number' => 0.6, 'unit' => 's', 'style' => '0.6s']], 'text_animation' => ['duration' => ['number' => 0.45, 'unit' => 's', 'style' => '0.45s']]], 'design' => ['toasts_container' => ['width' => ['number' => 300, 'unit' => 'px', 'style' => '300px'], 'height' => ['number' => 'auto', 'unit' => 'custom', 'style' => 'auto'], 'bottom' => ['number' => 20, 'unit' => 'px', 'style' => '20px'], 'right' => ['number' => 20, 'unit' => 'px', 'style' => '20px'], 'zindex' => 99], 'toasts' => ['padding' => ['padding' => ['breakpoint_base' => ['left' => ['number' => 16, 'unit' => 'px', 'style' => '16px'], 'right' => ['number' => 16, 'unit' => 'px', 'style' => '16px'], 'top' => ['number' => 16, 'unit' => 'px', 'style' => '16px'], 'bottom' => ['number' => 16, 'unit' => 'px', 'style' => '16px']]]], 'background' => ['color' => ['breakpoint_base' => '#000']], 'borders' => ['border' => ['breakpoint_base' => ['top' => ['width' => ['number' => 1, 'unit' => 'px', 'style' => '1px'], 'color' => '#272729', 'style' => 'solid'], 'bottom' => ['width' => ['number' => 1, 'unit' => 'px', 'style' => '1px'], 'color' => '#272729', 'style' => 'solid'], 'left' => ['width' => ['number' => 1, 'unit' => 'px', 'style' => '1px'], 'color' => '#272729', 'style' => 'solid'], 'right' => ['width' => ['number' => 1, 'unit' => 'px', 'style' => '1px'], 'color' => '#272729', 'style' => 'solid']]], 'radius' => ['breakpoint_base' => ['all' => ['number' => 10, 'unit' => 'px', 'style' => '10px'], 'topLeft' => ['number' => 10, 'unit' => 'px', 'style' => '10px'], 'topRight' => ['number' => 10, 'unit' => 'px', 'style' => '10px'], 'bottomLeft' => ['number' => 10, 'unit' => 'px', 'style' => '10px'], 'bottomRight' => ['number' => 10, 'unit' => 'px', 'style' => '10px'], 'editMode' => 'all']]], 'gap' => ['number' => 8, 'unit' => 'px', 'style' => '8px']], 'title_and_message' => ['title_typography' => ['color' => ['breakpoint_base' => '#fff'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => ['number' => 17, 'unit' => 'px', 'style' => '17px']], 'fontWeight' => ['breakpoint_base' => '500']]]]], 'message_typography' => ['color' => ['breakpoint_base' => '#6b7280'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => ['number' => 14, 'unit' => 'px', 'style' => '14px']]]]]]], 'close_button' => ['padding' => ['padding' => ['breakpoint_base' => ['left' => ['number' => 4, 'unit' => 'px', 'style' => '4px'], 'right' => ['number' => 4, 'unit' => 'px', 'style' => '4px'], 'top' => ['number' => 4, 'unit' => 'px', 'style' => '4px'], 'bottom' => ['number' => 4, 'unit' => 'px', 'style' => '4px']]]], 'dimensions' => ['number' => 24, 'unit' => 'px', 'style' => '24px'], 'stroke_color' => '#6b7280', 'stroke_width' => ['number' => 2, 'unit' => 'px', 'style' => '2px'], 'borders' => ['radius' => ['breakpoint_base' => ['all' => ['number' => 8, 'unit' => 'px', 'style' => '8px'], 'topLeft' => ['number' => 8, 'unit' => 'px', 'style' => '8px'], 'topRight' => ['number' => 8, 'unit' => 'px', 'style' => '8px'], 'bottomLeft' => ['number' => 8, 'unit' => 'px', 'style' => '8px'], 'bottomRight' => ['number' => 8, 'unit' => 'px', 'style' => '8px'], 'editMode' => 'all']]], 'background' => ['color' => ['breakpoint_base' => '#f3f4f6']]], 'borders' => ['radius' => ['breakpoint_base' => ['all' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'topLeft' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'topRight' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'bottomLeft' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'bottomRight' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'editMode' => 'all']]], 'duplicated_arrow_styles' => ['border_radius' => ['all' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'topLeft' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'topRight' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'bottomLeft' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'bottomRight' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'editMode' => 'all'], 'color' => '#fff', 'background' => 'rgb(65, 153, 241)', 'padding' => ['breakpoint_base' => ['left' => ['number' => 10, 'unit' => 'px', 'style' => '10px'], 'right' => ['number' => 10, 'unit' => 'px', 'style' => '10px'], 'top' => ['number' => 10, 'unit' => 'px', 'style' => '10px'], 'bottom' => ['number' => 10, 'unit' => 'px', 'style' => '10px']]], 'type' => 'type2'], 'arrow_styles' => ['type' => 'type2', 'color' => '#000', 'background' => '#fff', 'border_radius' => ['all' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'topLeft' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'topRight' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'bottomLeft' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'bottomRight' => ['number' => 100, 'unit' => 'px', 'style' => '100px'], 'editMode' => 'all'], 'padding' => ['breakpoint_base' => ['left' => ['number' => 2, 'unit' => 'px', 'style' => '2px'], 'right' => ['number' => 2, 'unit' => 'px', 'style' => '2px'], 'top' => ['number' => 2, 'unit' => 'px', 'style' => '2px'], 'bottom' => ['number' => 2, 'unit' => 'px', 'style' => '2px']]], 'dimensions' => ['breakpoint_base' => ['number' => 12, 'unit' => 'px', 'style' => '12px']], 'duplicated_arrow_left' => ['breakpoint_base' => ['number' => 15, 'unit' => 'px', 'style' => '15px']], 'weight' => ['breakpoint_base' => ['number' => 10, 'unit' => '%', 'style' => '10%']]], 'background' => ['color' => ['breakpoint_base' => '#2d9df8']], 'typography' => ['color' => ['breakpoint_base' => '#fff'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => ['number' => 16, 'unit' => 'px', 'style' => '16px']], 'fontWeight' => ['breakpoint_base' => '500'], 'advanced' => ['lineHeight' => ['breakpoint_base' => ['number' => 'normal', 'unit' => 'custom', 'style' => 'normal']]], 'fontWeight_hover' => null, 'advanced_hover' => null]]]], 'padding' => ['padding' => ['breakpoint_base' => ['top' => ['number' => 15, 'unit' => 'px', 'style' => '15px'], 'bottom' => ['number' => 15, 'unit' => 'px', 'style' => '15px'], 'left' => ['number' => 20, 'unit' => 'px', 'style' => '20px'], 'right' => ['number' => 20, 'unit' => 'px', 'style' => '20px']]]], 'gap' => ['breakpoint_base' => ['number' => 8, 'unit' => 'px', 'style' => '8px']], 'layout' => ['gap' => ['breakpoint_base' => ['number' => 20, 'unit' => 'px', 'style' => '20px']]]]];
    }
    ...
    static function contentControls()
    {
        ...
        "Scale",
        [],
        ['type' => 'number', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'svw', 'svh', 'auto', 'custom']]],
        true,
        false,
        [],
      ), c(
    ...
    static function dependencies()
    {
        return [
            '0' => [
                'title' => 'Dancepad - Arrow Button V7',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Arrow_Button_v7/dancepad_arrow_button_v7.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' => [
                'title' => 'Init Builder',
                'inlineScripts' => ['dancepad_arrow_button_v7();'],
...
'onPropertyChange' => [['script' => 'dancepad_arrow_button_v7();',
],],

'onCreatedElement' => [['script' => 'dancepad_arrow_button_v7();',
],],

'onMountedElement' => [['script' => 'dancepad_arrow_button_v7();',
],],

'onMovedElement' => [['script' => 'dancepad_arrow_button_v7();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_arrow_button_v7();',
],],];
    }
