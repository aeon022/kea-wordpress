...
if(get_option('dan_image_reveal_v3_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\ImageRevealV3",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class ImageRevealV3 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Image Reveal V3';
    }

    static function className()
    {
        return 'dan-image-reveal-v3';
    }
    ...
    {
        return ['content' => ['content' => ['source' => ['id' => -1, 'type' => 'external_image', 'url' => 'https://dancepad.io/wp-content/uploads/2024/11/dancepad-buttons.png', 'alt' => '', 'caption' => '']], 'animation' => ['duration' => ['number' => 0.8, 'unit' => 's', 'style' => '0.8s'], 'delay' => ['number' => 0.2, 'unit' => 's', 'style' => '0.2s'], 'gsap_easing' => 'power3'], 'scrolltrigger' => ['scrub' => '0', 'end' => 'unset', 'start' => 'top bottom', 'trigger' => 'this', 'toggleactions' => 'play none none none']], 'design' => ['size' => ['width' => ['breakpoint_base' => ['number' => 400, 'unit' => 'px', 'style' => '400px']], 'height' => ['breakpoint_base' => ['number' => 400, 'unit' => 'px', 'style' => '400px']]], 'columns' => ['color' => '#e3e3e3', 'width' => ['number' => 30, 'unit' => 'px', 'style' => '30px']]]];
    }
    ...
    static function dependencies()
    {
        return [
            '0' => [
                'title' => 'Dancepad - Image Reveal V3',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Image_Reveal_v3/dancepad_image_reveal_v3.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' => [
                'title' => 'Init Builder',
                'inlineScripts' => ['dancepad_image_reveal_v3();'],
...
'onPropertyChange' => [['script' => 'dancepad_image_reveal_v3();',
],],

'onCreatedElement' => [['script' => 'dancepad_image_reveal_v3();',
],],

'onMountedElement' => [['script' => 'dancepad_image_reveal_v3();',
],],

'onMovedElement' => [['script' => 'dancepad_image_reveal_v3();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_image_reveal_v3();',
],],];
    }
...
{% else %}
0
{% endif %}'], ['name' => 'data-flickering', 'template' => '1'], ['name' => 'data-columns-width', 'template' => '{{ design.columns.width.style }}']];
    }
