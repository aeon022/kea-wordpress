...
if(get_option('dan_mousefill_title_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\MousefillTitle",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class MousefillTitle extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Mousefill Title';
        }
    
        static function className()
        {
            return 'dan-mousefill-title';
        }
        ...
        {
            return ['content' => ['content' => ['text' => 'Mousefill Title', 'tag' => 'span', 'link' => null], 'animation' => ['duration' => ['number' => 0.6, 'unit' => 's', 'style' => '0.6s'], 'distance' => ['number' => 100, 'unit' => '%', 'style' => '100%'], 'split_type' => 'chars', 'from' => 'bottom', 'distance_dynamic_meta' => null, 'skew' => 0, 'stagger' => 0.05, 'delay' => ['number' => 0, 'unit' => 's', 'style' => '0s'], 'gsap_easing' => 'power3', 'blur' => ['number' => 20, 'unit' => 'px', 'style' => '20px'], 'trigger' => 'this'], 'scrolltrigger' => ['additional_triggers' => null, 'trigger' => 'this', 'start' => 'top bottom', 'end' => 'unset', 'toggleactions' => 'play none none none']], 'design' => ['typography' => ['text' => ['custom' => ['customTypography' => ['fontFamily' => null, 'fontSize' => ['number' => 75, 'unit' => 'px', 'style' => '75px'], 'advanced' => ['letterSpacing' => null]]]], 'color' => null, 'color_hover' => null, 'typography' => ['custom' => ['customTypography' => ['fontFamily' => ['breakpoint_base' => 'gfont-intertight'], 'fontSize' => ['breakpoint_base' => ['number' => 64, 'unit' => 'px', 'style' => '64px']], 'fontFamily_hover' => null, 'fontSize_hover' => null]]]], 'elements_hive' => ['backlight' => ['enabled' => false]], 'style' => ['new_control' => ['label' => 'Preset 0', 'id' => 'preset-id-72d05461-b30c-4ca4-be1a-3a678f1d3fcf'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => null, 'fontFamily' => null]]]], 'stroke_fill' => ['stroke_color' => '#000', 'stroke_width' => ['number' => 2, 'unit' => 'px', 'style' => '2px'], 'fill_color' => '#000']]];
        }
        ...
        static function dependencies()
        {
            return [
                '0' =>  [
                    'title' => 'Dancepad - Mousefill Title',
                    'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Mousefill_Title/dancepad_mousefill_title.min.js?ver=' . DANCEPAD_VERSION],
                ],
                '1' =>  [
                    'title' => 'Init Builder',
                    'inlineScripts' => [
                        'dancepad_mousefill_title();'
                    ],
    ...
    'onPropertyChange' => [['script' => 'dancepad_mousefill_title();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_mousefill_title();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_mousefill_title();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_mousefill_title();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_mousefill_title();',
    ],],];
        }
        ...
        {
            return [['name' => 'data-trigger', 'template' => '{{ content.animation.trigger|default("") }}'], ['name' => 'data-duration', 'template' => '{{ content.animation.duration.style|default("0.6s") }}'], ['name' => 'data-easing', 'template' => '{{ content.animation.gsap_easing|default("power3") }}'], ['name' => 'data-shadow', 'template' => '{{ content.animation.shadow }}']];
        }
