...
if(get_option('dan_proximity_weight_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\ProximityWeight",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class ProximityWeight extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Proximity Hover';
    }

    static function className()
    {
        return 'dan-proximity-weight';
    }
    ...
    {
        return ['content' => ['animation' => ['type' => 'weight', 'radius' => 150, 'min_weight' => 100, 'max_weight' => 900, 'min_scale' => 1, 'max_scale' => 1.5, 'css_easing' => 'ease-out', 'duration' => ['number' => 0.075, 'unit' => 's', 'style' => '0.075s']], 'content' => ['text' => 'Proximity Hover', 'tag' => 'span']], 'design' => ['typography' => ['color' => ['breakpoint_base' => '#000'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => ['number' => 32, 'unit' => 'px', 'style' => '32px']]]]]]]];
    }
    ...
    static function contentControls()
    {
        ...
        "Type",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'unitOptions' => ['types' => ['s']], 'items' => [['value' => 'weight', 'text' => 'Weight'], ['text' => 'Size', 'value' => 'size']]],
        false,
        false,
        [],
      ), c(
        ...
        "min Weight",
        [],
        ['type' => 'number', 'layout' => 'inline', 'unitOptions' => ['types' => ['s']], 'condition' => [[['path' => 'content.animation.type', 'operand' => 'equals', 'value' => 'weight']]]],
        false,
        false,
        [],
      ), c(
        ...
        "min Scale",
        [],
        ['type' => 'number', 'layout' => 'inline', 'unitOptions' => ['types' => ['s']], 'condition' => [[['path' => 'content.animation.type', 'operand' => 'equals', 'value' => 'size']]]],
        false,
        false,
        [],
      ), c(
    ...
    {
        return [
          '0' =>  ['title' => 'Dancepad - Proximity Weight','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Proximity_Weight/dancepad_proximity_weight.min.js?ver=' . DANCEPAD_VERSION],],
          '1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_proximity_weight();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],
          '2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_proximity_weight();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],
...
'onPropertyChange' => [['script' => 'dancepad_proximity_weight();',
],],

'onCreatedElement' => [['script' => 'dancepad_proximity_weight();',
],],

'onMountedElement' => [['script' => 'dancepad_proximity_weight();',
],],

'onMovedElement' => [['script' => 'dancepad_proximity_weight();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_proximity_weight();',
],],];
    }
