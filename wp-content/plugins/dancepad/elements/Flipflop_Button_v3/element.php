...
if(get_option('dan_flipflop_button_v3_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\FlipflopButtonV3",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class FlipflopButtonV3 extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Flipflop Button V3';
        }
    
        static function className()
        {
            return 'dan-flipflop-button-v3';
        }
