...
if(get_option('dan_swap_reading_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\SwapReading",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class SwapReading extends \Breakdance\Elements\Element
    {
        ...
        {
            return ['content' => ['scrolltrigger' => ['scroller' => 'body', 'start' => 'top center+=300', 'end' => 'bottom center-=100'], 'animation' => ['duration' => ['number' => 0.5, 'unit' => 's', 'style' => '0.5s'], 'gsap_easing' => 'none'], 'content' => ['tag' => 'p', 'text' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec leo et mi mollis dictum. Vivamus bibendum est vel elit eleifend sodales. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec leo et mi mollis dictum. Vivamus bibendum est vel elit eleifend sodales. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec leo et mi mollis dictum. Vivamus bibendum est vel elit eleifend sodales. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec leo et mi mollis dictum. Vivamus bibendum est vel elit eleifend sodales.']], 'design' => ['dimensions' => ['paragraph_width' => ['breakpoint_base' => ['number' => 800, 'unit' => 'px', 'style' => '800px']], 'width' => ['breakpoint_base' => ['number' => 100, 'unit' => '%', 'style' => '100%']]], 'typography' => ['typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => ['number' => 64, 'unit' => 'px', 'style' => '64px']], 'advanced' => ['lineHeight' => ['breakpoint_base' => ['number' => '1.1', 'unit' => 'custom', 'style' => '1.1']]]]]], 'text_align' => ['breakpoint_base' => 'center']]]];
        }
        ...
        {
            return [
              '0' =>  ['title' => 'Dancepad - Swap Reading','scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Swap_Reading/dancepad_swap_reading.min.js?ver=' . DANCEPAD_VERSION],],
              '1' =>  ['title' => 'Init Builder','inlineScripts' => ['dancepad_swap_reading();'],'builderCondition' => 'return true;','frontendCondition' => 'return false;',],
              '2' =>  ['title' => 'Init Front','inlineScripts' => ['dancepad_swap_reading();'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],
    ...
    'onPropertyChange' => [['script' => 'dancepad_swap_reading();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_swap_reading();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_swap_reading();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_swap_reading();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_swap_reading();',
    ],],];
        }
        ...
        {
            return [['name' => 'data-duration', 'template' => '{{ content.animation.duration.style }}'], ['name' => 'data-ease', 'template' => '{{ content.animation.gsap_easing }}'], ['name' => 'data-start', 'template' => '{{ content.scrolltrigger.start }}'], ['name' => 'data-end', 'template' => '{{ content.scrolltrigger.end }}'], ['name' => 'data-scroller', 'template' => '{{ content.scrolltrigger.scroller }}']];
        }
