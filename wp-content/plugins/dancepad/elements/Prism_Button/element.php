...
if(get_option('dan_prism_button_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\PrismButton",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class PrismButton extends \Breakdance\Elements\Element
{
    ...
    {
        return ['content' => ['content' => ['text' => 'Prism Button', 'tag' => 'span', 'link' => null, 'top_prism_text' => 'Top Prism', 'bottom_prism_text' => 'Bottom prism', 'prism_text' => 'Prism Button', 'swap_text' => 'Swapped!', 'white_space' => 'nowrap', 'front_text' => 'Front Prism', 'back_text' => 'Back Prism'], 'animation' => ['duration' => ['number' => 0.5, 'unit' => 's', 'style' => '0.5s'], 'distance' => ['number' => 100, 'unit' => '%', 'style' => '100%'], 'split_type' => 'chars', 'from' => 'top', 'distance_dynamic_meta' => null, 'skew' => ['number' => 10, 'unit' => 'deg', 'style' => '10deg'], 'stagger' => 0.05, 'delay' => ['number' => 0, 'unit' => 's', 'style' => '0s'], 'gsap_easing' => 'power3', 'blur' => ['number' => 20, 'unit' => 'px', 'style' => '20px'], 'css_easing' => 'cubic-bezier(0.645, 0.045, 0.355, 1)', 'type' => 'dan-prism-button--from-top', 'amplitude' => ['number' => 0, 'unit' => '%', 'style' => '0%'], 'in_duration' => ['number' => 0.8, 'unit' => 's', 'style' => '0.8s'], 'out_duration' => ['number' => 0.8, 'unit' => 's', 'style' => '0.8s'], 'scale' => 1.1, 'scale_duration' => ['number' => 0.5, 'unit' => 's', 'style' => '0.5s'], 'scale_easing' => 'cubic-bezier(.76,0,.24,1)', 'scale_delay' => ['number' => 0, 'unit' => 's', 'style' => '0s'], 'translate_easing' => 'ease-out', 'translate_duration' => ['number' => 0.75, 'unit' => 's', 'style' => '0.75s'], 'translate_delay' => ['number' => 0, 'unit' => 's', 'style' => '0s'], 'translate' => ['number' => 15, 'unit' => 'px', 'style' => '15px'], 'rotate_delay' => ['number' => 0.2, 'unit' => 's', 'style' => '0.2s'], 'rotate_duration' => ['number' => 0.75, 'unit' => 's', 'style' => '0.75s'], 'rotate' => ['number' => 90, 'unit' => 'deg', 'style' => '90deg'], 'rotate_easing' => 'cubic-bezier(.76,0,.24,1)', 'prism_speed' => ['number' => 3, 'unit' => 's', 'style' => '3s'], 'prism_easing' => 'linear', 'swap_easing' => 'ease-out', 'swap_duration' => ['number' => 0.25, 'unit' => 's', 'style' => '0.25s'], 'swap_delay' => ['number' => 0, 'unit' => 's', 'style' => '0s'], 'background_duration' => ['number' => 0.25, 'unit' => 's', 'style' => '0.25s'], 'background_easing' => 'ease-out', 'background_delay' => ['number' => 0, 'unit' => 's', 'style' => '0s'], 'prism_gap' => ['number' => 15, 'unit' => 'px', 'style' => '15px'], 'repeats' => 8, 'repeats_gap' => ['number' => 10, 'unit' => 'px', 'style' => '10px'], 'animation_duration' => ['number' => 3, 'unit' => 's', 'style' => '3s'], 'fade_duration' => ['number' => 0.5, 'unit' => 's', 'style' => '0.5s'], 'spark_dimensions' => ['number' => 1, 'unit' => 'px', 'style' => '1px'], 'perspective' => ['number' => 500, 'unit' => 'px', 'style' => '500px']], 'scrolltrigger' => ['additional_triggers' => null, 'trigger' => 'this', 'start' => 'top bottom', 'end' => 'unset', 'toggleactions' => 'play none none none'], 'underline' => ['type' => 'Side to Side', 'bottom_distance' => ['number' => 0, 'unit' => 'px', 'style' => '0px'], 'thickness' => ['number' => 1, 'unit' => 'px', 'style' => '1px'], 'initial_width' => ['number' => 0, 'unit' => 'px', 'style' => '0px'], 'duration' => ['number' => 0.7, 'unit' => 's', 'style' => '0.7s'], 'css_easing' => 'cubic-bezier(0.16, 1, 0.3, 1)', 'color' => 'currentColor'], 'spark' => ['color' => 'rgba(0,0,0,.5)', 'path_color' => 'white', 'dimensions' => ['number' => 2, 'unit' => 'px', 'style' => '2px'], 'animation_duration' => ['number' => 5, 'unit' => 's', 'style' => '5s']]], 'design' => ['typography' => ['text' => ['custom' => ['customTypography' => ['fontFamily' => null, 'fontSize' => ['number' => 75, 'unit' => 'px', 'style' => '75px'], 'advanced' => ['letterSpacing' => null]]]], 'color' => null, 'color_hover' => null, 'typography' => ['custom' => ['customTypography' => ['fontFamily' => null, 'fontSize' => ['breakpoint_base' => ['number' => 20, 'unit' => 'px', 'style' => '20px']], 'fontFamily_hover' => null, 'fontSize_hover' => null, 'advanced' => ['lineHeight' => ['breakpoint_base' => ['number' => 'normal', 'unit' => 'custom', 'style' => 'normal']]]]]]], 'elements_hive' => ['backlight' => ['enabled' => false]], 'style' => ['new_control' => ['label' => 'Preset 0', 'id' => 'preset-id-72d05461-b30c-4ca4-be1a-3a678f1d3fcf'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => null, 'fontFamily' => null]]]], 'padding' => ['padding' => ['breakpoint_base' => ['top' => ['number' => 15, 'unit' => 'px', 'style' => '15px'], 'bottom' => ['number' => 15, 'unit' => 'px', 'style' => '15px'], 'left' => ['number' => 32, 'unit' => 'px', 'style' => '32px'], 'right' => ['number' => 32, 'unit' => 'px', 'style' => '32px']]], 'spacing_padding_y' => ['padding_top' => ['breakpoint_base' => ['number' => 15, 'unit' => 'px', 'style' => '15px']], 'padding_bottom' => ['breakpoint_base' => ['number' => 15, 'unit' => 'px', 'style' => '15px']]], 'padding_top' => ['breakpoint_base' => ['number' => 10, 'unit' => 'px', 'style' => '10px']], 'padding_bottom' => ['breakpoint_base' => ['number' => 10, 'unit' => 'px', 'style' => '10px']], 'padding_left' => ['breakpoint_base' => ['number' => 10, 'unit' => 'px', 'style' => '10px']], 'padding_right' => ['breakpoint_base' => ['number' => 10, 'unit' => 'px', 'style' => '10px']]], 'borders' => ['radius' => ['breakpoint_base' => ['all' => ['number' => 50, 'unit' => 'px', 'style' => '50px'], 'topLeft' => ['number' => 50, 'unit' => 'px', 'style' => '50px'], 'topRight' => ['number' => 50, 'unit' => 'px', 'style' => '50px'], 'bottomLeft' => ['number' => 50, 'unit' => 'px', 'style' => '50px'], 'bottomRight' => ['number' => 50, 'unit' => 'px', 'style' => '50px'], 'editMode' => 'all']], 'border' => null], 'background' => ['button' => '#E3E3E3', 'mask' => '#000000FF'], 'mask_typography' => ['color' => ['breakpoint_base' => '#FFF']], 'margin' => ['margin' => ['breakpoint_base' => ['top' => null]]], 'top_prism' => ['background' => 'greenyellow', 'text_color' => 'black'], 'bottom_prism' => ['background' => 'black', 'text_color' => 'white'], 'mask_colors' => ['text_color' => 'white', 'background' => 'black'], 'button_colors' => ['text_color' => 'black', 'background' => '#e3e3e3'], 'button_typography' => ['typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => ['number' => 20, 'unit' => 'px', 'style' => '20px']]]]], 'color' => ['breakpoint_base' => '#000000FF']], 'prism_typography' => ['typography' => ['custom' => ['customTypography' => ['fontSize' => null, 'fontSize_hover' => null]]]], 'button_background' => ['background' => '#e3e3e3'], 'front_background' => ['background' => '#e3e3e3'], 'front_typography' => ['color' => ['breakpoint_base' => '#000'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => null]]]], 'text_align' => ['breakpoint_base' => 'center']], 'back_typography' => ['color' => ['breakpoint_base' => '#FFF'], 'text_align' => ['breakpoint_base' => 'center'], 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['breakpoint_base' => null]]]]], 'back_background' => ['background' => '#000'], 'shared_font_size' => ['font_size' => ['breakpoint_base' => ['number' => 20, 'unit' => 'px', 'style' => '20px']]]]];
    }
    ...
    {
        return [['name' => 'data-from', 'template' => '{{ content.animation.from }}']];
    }
    ...
    {
        return [['accepts' => 'string', 'path' => 'content.animation.distance'], ['accepts' => 'string', 'path' => 'content.content.front_text'], ['accepts' => 'string', 'path' => 'content.content.back_text']];
    }
