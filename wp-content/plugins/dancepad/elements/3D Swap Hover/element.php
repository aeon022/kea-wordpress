...
if(get_option('dan_3d_swap_hover_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\ThreeDSwapHover",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class ThreeDSwapHover extends \Breakdance\Elements\Element
    {
        ...
        {
            return '3D Swap Hover';
        }
    
        static function className()
        {
            return 'dan-3d-swap-hover';
        }
        ...
        static function dependencies()
        {
            return [
                '0' =>  [
                    'title' => 'Dancepad - 3D Swap Hover',
                    'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/3D Swap Hover/dancepad_3d_swap_hover.min.js?ver=' . DANCEPAD_VERSION],
                ],
                '1' =>  [
                    'title' => 'Init Builder',
                    'inlineScripts' => ['dancepad_3d_swap_hover();'],
    ...
    'onPropertyChange' => [['script' => 'dancepad_3d_swap_hover();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_3d_swap_hover();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_3d_swap_hover();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_3d_swap_hover();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_3d_swap_hover();',
    ],],];
        }
        ...
        {
            return [['accepts' => 'string', 'path' => 'content.animation.distance'], ['accepts' => 'string', 'path' => 'content.content.text'], ['accepts' => 'string', 'path' => 'content.content.swapped_text']];
        }
