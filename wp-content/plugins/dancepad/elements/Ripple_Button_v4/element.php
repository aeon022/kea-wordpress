...
if(get_option('dan_ripple_button_v4_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\RippleButtonV4",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class RippleButtonV4 extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Ripple Button V4';
    }

    static function className()
    {
        return 'dan-ripple-button-v4';
    }
    ...
    {
        return [['accepts' => 'image_url', 'path' => 'design.blurry_background.layers[].image']];
    }
