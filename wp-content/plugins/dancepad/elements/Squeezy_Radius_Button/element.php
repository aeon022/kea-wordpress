...
if(get_option('dan_squeezy_radius_button_enable') == 'true'){
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\SqueezyRadiusButton",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class SqueezyRadiusButton extends \Breakdance\Elements\Element
{
    ...
    {
        return 'Squeezy Radius Button';
    }

    static function className()
    {
        return 'dan-squeezy-radius-button';
    }
