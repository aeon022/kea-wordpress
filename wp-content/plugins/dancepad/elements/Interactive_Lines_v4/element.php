...
if(get_option('dan_interactive_lines_v4_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\Interactive_Lines_v4",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class Interactive_Lines_v4 extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Interactive Lines V4';
        }
    
        static function className()
        {
            return 'dan-interactive-lines-v4';
        }
        ...
        static function dependencies()
        {
            return [
                '0' => [
                    'title' => 'Dancepad - Interactive Lines v4',
                    'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Interactive_Lines_v4/dancepad_interactive_lines_v4.min.js?ver=' . DANCEPAD_VERSION],
                ],
                '1' => [
                    'title' => 'Init Builder',
                    'inlineScripts' => ['dancepad_interactive_lines_v4();'],
    ...
    'onPropertyChange' => [['script' => 'dancepad_interactive_lines_v4();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_interactive_lines_v4();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_interactive_lines_v4();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_interactive_lines_v4();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_interactive_lines_v4();',
    ],],];
        }
        ...
        {
            return [['name' => 'data-wave-speed-x', 'template' => '{{ content.animation.wave_speed_x }}'], ['name' => 'data-wave-speed-y', 'template' => '{{ content.animation.wave_speed_y }}'], ['name' => 'data-wave-amp-x', 'template' => '{{ content.animation.wave_amplitude_x }}'], ['name' => 'data-wave-amp-y', 'template' => '{{ content.animation.wave_amplitude_y }}'], ['name' => 'data-x-gap', 'template' => '{{ content.animation.x_gap }}'], ['name' => 'data-y-gap', 'template' => '{{ content.animation.y_gap }}'], ['name' => 'data-friction', 'template' => '{{ content.animation.friction }}'], ['name' => 'data-tension', 'template' => '{{ content.animation.tension }}'], ['name' => 'data-max-cursor-move', 'template' => '{{ content.animation.max_cursor_move }}']];
        }
