...
if(get_option('dan_blurry_button_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\BlurryButton",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class BlurryButton extends \Breakdance\Elements\Element
    {
        ...
        {
            return 'Blurry Button';
        }
    
        static function className()
        {
            return 'dan-blurry-button';
        }
