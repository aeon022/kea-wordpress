...
if(get_option('dan_decode_hover_enable') == 'true'){
    \Breakdance\ElementStudio\registerElementForEditing(
        "Dancepad\\DecodeHover",
        \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
    );
    
    class DecodeHover extends \Breakdance\Elements\Element
    {
        ...
        static function contentControls()
        {
            ...
            "Decode alphabet",
            [],
            ['type' => 'text', 'layout' => 'vertical', 'unitOptions' => ['types' => ['px']], 'textOptions' => ['multiline' => true]],
            false,
            false,
            [],
          ), c(
            ...
            "From",
            [],
            ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => '-1', 'text' => 'left'], ['text' => 'right', 'value' => '1']]],
            false,
            false,
            [],
          ), c(
        ...
        static function dependencies()
        {
            return [
                '0' =>  [
                    'title' => 'Dancepad - Decode Hover',
                    'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Decode Hover/dancepad_decode_hover.min.js?ver=' . DANCEPAD_VERSION],
                ],
                '1' =>  [
                    'title' => 'Init Builder',
                    'inlineScripts' => [
                        'dancepad_decode_hover();'
                    ],
    ...
    'onPropertyChange' => [['script' => 'dancepad_decode_hover();',
    ],],
    
    'onCreatedElement' => [['script' => 'dancepad_decode_hover();',
    ],],
    
    'onMountedElement' => [['script' => 'dancepad_decode_hover();',
    ],],
    
    'onMovedElement' => [['script' => 'dancepad_decode_hover();',
    ],],
    
    'onAfterDeletedElement' => [['script' => 'dancepad_decode_hover();',
    ],],];
        }
        ...
        {
            return [['name' => 'data-duration', 'template' => '{{ content.animation.duration.style }}'], ['name' => 'data-delay', 'template' => '{{ content.animation.delay.style }}'], ['name' => 'data-easing', 'template' => '{{ content.animation.gsap_easing }}'], ['name' => 'data-decodealphabet', 'template' => '{{ content.animation.decode_alphabet }}'], ['name' => 'data-from-right', 'template' => '{{ content.animation.from }}']];
        }
