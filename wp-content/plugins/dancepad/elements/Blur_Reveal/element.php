...
if(get_option('dan_blur_reveal_enable') == 'true') {
  \Breakdance\ElementStudio\registerElementForEditing(
    "Dancepad\\BlurReveal",
    \Breakdance\Util\getdirectoryPathRelativeToPluginFolder(__DIR__)
);

class BlurReveal extends \Breakdance\Elements\Element
{
    ...
    static function dependencies()
    {
        return [
            '0' =>  [
                'title' => 'Dancepad - Blur Reveal',
                'scripts' => [DANCEPAD_PLUGIN_URL . 'elements/Blur_Reveal/dancepad_blur_reveal.min.js?ver=' . DANCEPAD_VERSION],
            ],
            '1' =>  [
                'title' => 'Init Builder',
                'inlineScripts' => [
                    'dancepad_blur_reveal();'
                ],
...
'onPropertyChange' => [['script' => 'dancepad_blur_reveal();',
],],

'onCreatedElement' => [['script' => 'dancepad_blur_reveal();',
],],

'onMountedElement' => [['script' => 'dancepad_blur_reveal();',
],],

'onMovedElement' => [['script' => 'dancepad_blur_reveal();',
],],

'onAfterDeletedElement' => [['script' => 'dancepad_blur_reveal();',
],],];
    }
    ...
    static function attributes()
    {
        return [
            ...
            ['name' => 'data-blur-from', 'template' => '{{ content.animation.blur.style }}'],
            ['name' => 'data-translate-y', 'template' => '{{ content.animation.translate_y.style }}'],
            ['name' => 'data-skew', 'template' => '{{ content.animation.skew.style }}'],
