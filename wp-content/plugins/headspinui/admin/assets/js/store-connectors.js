		...
		boilerplates: [
			{
				...
				data: [
					{
						name: 'Section',
						description: "Section related variables. This group controls the high-level structural layout of your pages. These variables ensure consistency in how content is framed and spaced across every section of the site.\nNOTE: This will override Breakdance Global Settings > Containers > SECTION. If you use here, changes in Breakdance won't have any effect!",
						folder: {
							name: 'Breakdance',
							icon: 'ii-breakdance',
						...
						data: [
							{
								...
								"dark": "",
								"light": "",
								"plainText": "calc(var(--hsx-page-width) + 2 * var(--hsx-min-offset))",
					...
					},
					{
						...
						name: 'Global Colors',
						description: "Global Colors related variables connection. This group manages the source of truth for your site’s color palette. By connecting these to CSS variables, any change made here will instantly update every element across the site using that variable..\nNOTE: This will override Breakdance Global Settings > Colors (Brand, Text, Headings, Links and Background). If this is enabled, Headspin will takeover control and chnages inside Global Settings (Color) won't have any effect.",
						folder: {
							name: 'Breakdance',
							icon: 'ii-breakdance',
							uuid: '50bf896c-939a-4e1c-bf53-771089e8d668',
					...
					{
						name: 'Font Sizes',
						description: "Typography related variables connection. This will control font-size for headings (H1-H6) and for text. \nNOTE: If this is enabled, Breakdance Global Settings such as base size and ratio won't have any effect as these are overtaken by Headspin.",
						folder: {
							name: 'Breakdance',
							icon: 'ii-breakdance',
							uuid: '50bf896c-939a-4e1c-bf53-771089e8d668',
