...
?>
<header class="kea-destination-list__header"><div><?php if (($content['eyebrow'] ?? '') !== '') : ?><p><?php echo esc_html((string) $content['eyebrow']); ?></p><?php endif; ?><?php if ($isArchive) : ?><h1><?php echo esc_html((string) ($content['title'] ?? '')); ?></h1><?php else : ?><h2><?php echo esc_html((string) ($content['title'] ?? '')); ?></h2><?php endif; ?></div><?php if (($content['intro'] ?? '') !== '') : ?><div><?php echo esc_html((string) $content['intro']); ?></div><?php endif; ?></header>
