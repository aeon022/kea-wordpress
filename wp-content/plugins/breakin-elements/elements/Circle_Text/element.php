...
class CircleText extends \Breakdance\Elements\Element
{
    ...
    {
        return ['content' => ['content' => ['text' => 'this is a long text...this is a long text...this is a long text...this is a long text...', 'radius' => 110, 'rotation' => 184, 'animate' => true, 'speed' => ['number' => 5, 'unit' => 's', 'style' => '5s']]], 'design' => ['design' => ['width' => ['number' => 400, 'unit' => 'px', 'style' => '400px'], 'typography' => ['color' => '#000000FF', 'typography' => ['custom' => ['customTypography' => ['fontSize' => ['number' => 25, 'unit' => 'px', 'style' => '25px']]]]]]]];
    }
    ...
    static function contentControls()
    {
        ...
        "Radius",
        [],
        ['type' => 'number', 'layout' => 'inline', 'rangeOptions' => ['min' => 50, 'max' => 200, 'step' => 10]],
        false,
        false,
        [],
      ), c(
        ...
        "Inverse",
        [],
        ['type' => 'toggle', 'layout' => 'inline', 'condition' => [[['path' => 'content.content.animate', 'operand' => 'is set', 'value' => '']]]],
        false,
        false,
        [],
      ), c(
        ...
        "Speed",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'condition' => [[['path' => 'content.content.animate', 'operand' => 'is set', 'value' => '']]], 'unitOptions' => ['types' => ['s', 'ms']]],
        false,
        false,
        [],
      )],
    ...
    {
        return [['name' => 'rotatingcircle', 'template' => '{% if content.content.animate and not content.content.inverse %}
yes
{% endif %}'], ['name' => 'rotatingcircleinv', 'template' => '{% if content.content.animate and content.content.inverse %}
yes
{% endif %}']];
    }
